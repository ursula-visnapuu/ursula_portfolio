...
(function ($, window, document, undefined) {
    ...
    var popup = {
        ...
        _createMarkup: function () {
            ...
            if (t.type === 'singlePage') {
                ...
                if (t.options.singlePageCounter) {
                    ...
                    t.options.singlePageCounter = t.counter.text();
                    t.counter.text('');
                }
        ...
        updateSinglePage: function (html) {
            ...
            if (t.counter) {
                t.counter.text(t._getCounterMarkup(t.options.singlePageCounter, t.current + 1, t.counterTotal));
            }
